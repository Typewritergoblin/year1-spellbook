...
**Stairs.** Webs fill all stairs in the warded area from top to bottom, as in the *@UUID[Compendium.dnd-players-handbook.spells.Item.phbsplWeb0000000]{Web}* spell. These strands regrow in 10 minutes if they are destroyed while *Guards and Wards* lasts.

**Other Spell Effect. **Place one of the following magical effects within the warded area:

*@UUID[Compendium.dnd-players-handbook.spells.Item.phbsplDancingLig]{Dancing Lights}* in four corridors, with a simple program that the lights repeat as long as *Guards and Wards* lasts*@UUID[Compendium.dnd-players-handbook.spells.Item.phbsplMagicMouth]{Magic Mouth}* in two locations*@UUID[Compendium.dnd-players-handbook.spells.Item.phbsplStinkingCl]{Stinking Cloud}* in two locations (the vapors return within 10 minutes if dispersed while *Guards and Wards* lasts)*@UUID[Compendium.dnd-players-handbook.spells.Item.phbsplGustofWind]{Gust of Wind}* in one corridor or room (the wind blows continuously while the spell lasts)*@UUID[Compendium.dnd-players-handbook.spells.Item.phbsplSuggestion]{Suggestion}* in one 5-foot square; any creature that enters that square receives the suggestion mentally
