...
title:  "Witch Bolt"
sources: [PHB 2024]
tags: [sorcerer, warlock, wizard, level1, concentration, action, evocation]
---
...
The spell ends if the target is ever outside the spell’s range or if it has Totalcover from you.
