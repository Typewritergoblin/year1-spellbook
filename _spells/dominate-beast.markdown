...
sources: [PHB 2024]
tags: [druid, ranger, sorcerer, level4, concentration, action, enchantment, dragonmark]
subtags: [{warlock: patron-archfey}, {dragonmark: handling}]
---
...
One Beast you can see within range must succeed on a Wisdom saving throw or have the &amp;Reference[Charmed apply=false] condition for the duration. The target has Advantage on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.
